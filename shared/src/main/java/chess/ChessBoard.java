...
public class ChessBoard {
    ...
    public void resetBoard() {
        ...
        for (int i = 0; i < 8; i++) {
            spaces[i][1] = new ChessPiece(ChessGame.TeamColor.WHITE, ChessPiece.PieceType.PAWN);
            spaces[i][6] = new ChessPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN);
        }
